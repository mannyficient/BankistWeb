...
const btnSroll = document.querySelector('.btn--scroll-to');
...
//common parent for event delegation
...
const obsvNavCallBack = function (entries, observer) {
...
const headerObsever = new IntersectionObserver(obsvNavCallBack, optionsNav)
...
const sectionObserver = new IntersectionObserver(revealSection, optSec)
...
// //getelementbyclassName --- returns live html collection
...
// classes
// add remove toggle contains dont use ClassName
